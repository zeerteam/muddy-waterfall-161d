...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/muddy-waterfall-161d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/muddy-waterfall-161d
```

A live public deployment of this template is available at [https://muddy-waterfall-161d.templates.workers.dev](https://muddy-waterfall-161d.templates.workers.dev)
